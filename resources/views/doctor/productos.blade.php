            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 flex justify-center items-center">
                    <div class="flex space-x-4">
                        ...
                        <button data-modal-target="editar-product-modal" data-modal-toggle="editar-product-modal" class="btn-custom focus:outline-none">
                            Editar
                        </button>
                        <button data-modal-target="eliminar-product-modal" data-modal-toggle="eliminar-product-modal" class="btn-custom focus:outline-none">
                            Eliminar
                        </button>
                    </div>
                </div>
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form id="editar-form" class="p-4 md:p-5" enctype="multipart/form-data" method="POST">
                ...
                <div class="mt-4">
                    <label for="edit-producto" class="block text-sm font-medium text-gray-900 dark:text-gray-300">Nombre</label>
                    <input id="edit-producto" class="block mt-1 w-full text-sm dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" type="text" name="nombre" required>
                </div>
                <div class="mt-4">
...
<script>
    document.getElementById('select-producto').addEventListener('change', function () {
        ...
        if (producto) {
            ...
            document.getElementById('edit-producto').value = producto.nombre;
